TRANSLATIONS = {
    ...
    "ITEMS_UNDERSTANDING_ERROR": {
        ...
        "HINGLISH": "Mujhe kapde samajh nahi aaye. Kya aap kripya unhe saaf-saaf likh sakte hain? (jaise, '3 shirts washing ke liye')",
        "GUJLISH": "Mne kapda samajh ma na avya. Su tame kripa kari ne saf-saf lakhi shako cho? (jem ke, '3 shirts dhova mate')"
    },
    "CLOSED_WARNING": {
        "ENGLISH": "🌙 Ashirwad Cleaners is currently closed. Our working hours are from 9:00 AM to 8:30 PM. Please message us during working hours to schedule your pickup!",
        "HINGLISH": "🌙 Ashirwad Cleaners abhi band hai. Humare kaam karne ka samay subah 9:00 AM se shaam 8:30 PM tak hai. Kripya is samay ke beech mein message karein taaki hum pickup schedule kar sakein!",
        "GUJLISH": "🌙 Ashirwad Cleaners atyare band che. Amaro kam karvano samay savere 9:00 AM thi sanje 8:30 PM no che. Kripa kari aa samay darmiyan message karo taaki ame pickup schedule kari shakiye!"
    },
    "PRICING_SELECTION_MSG": {
    ...
    "PRICING_AWAIT_SELECTION_ERROR": {
        ...
        "GUJLISH": "Kripa kari upar aapel category buttons mathi koi ek par tap karo."
    },
    "PRICING_CATALOG_FOOTER": {
        "ENGLISH": "\nTo schedule a pickup, just reply with 'Pickup'!",
        "HINGLISH": "\nPickup schedule karne ke liye, bas 'Pickup' reply karein!",
    ...
    "POINTS_BUTTON_YES": {
        ...
        "HINGLISH": "✅ Redeem ₹{max_redeemable}",
        "GUJLISH": "✅ Redeem ₹{max_redeemable}"
    },
    "POINTS_BUTTON_NO": {
        "ENGLISH": "❌ Save for later",
        "HINGLISH": "❌ Baad ke liye bachayein",
        "GUJLISH": "❌ Pachhi mate bachavo"
    },
    "POINTS_APPLIED_MSG": {
        "ENGLISH": "✅ **Points Applied**: -₹{points_redeemed} discount!\n",
        "HINGLISH": "✅ **Points Applied**: -₹{points_redeemed} discount!\n",
    ...
    "ADDRESS_BUTTON_YES": {
        ...
        "HINGLISH": "✅ Haan, ise use karein",
        "GUJLISH": "✅ Haan, aa vapro"
    },
    "ADDRESS_BUTTON_NEW": {
        "ENGLISH": "📝 New Address",
        "HINGLISH": "📝 Naya Address",
    ...
    "ADDRESS_INPUT_NEW_REQUEST": {
        ...
        "HINGLISH": "Kripya apna naya exact address (Flat/House Number aur Building Name) reply karein ya apna WhatsApp location pin share karein.",
        "GUJLISH": "Kripa kari aapno navo exact address (Flat/House Number ane Building Name) reply karo ke aapno WhatsApp location pin share karo."
    },
    "BUTTON_SELECTION_ERROR": {
        "ENGLISH": "Please tap one of the buttons.",
    ...
    "STATUS_NO_ORDERS": {
        ...
        "HINGLISH": "Aapka abhi koi active order nahi hai. Kya aap pickup schedule karna chahte hain? Bas 'Pickup' likhein!",
        "GUJLISH": "Aapno atyare koi active order nathi. Su tame pickup schedule karva mangso? Khali 'Pickup' lakho!"
    },
    "STATUS_SINGLE_ORDER": {
        "ENGLISH": "Order #{order_id} status: {status_name}. Estimated completion: Tomorrow.",
        "HINGLISH": "Order #{order_id} ka status: {status_name} hai. Kal tak pura hone ka andaza hai.",
        "GUJLISH": "Order #{order_id} no status: {status_name} che. Kal sudhi ma puru thavano andaj che."
    },
    "STATUS_MULTIPLE_ORDERS": {
        "ENGLISH": "You have multiple active orders:\n",
        "HINGLISH": "Aapke paas multiple active orders hain:\n",
        "GUJLISH": "Aapni pase multiple active orders che:\n"
    },
    "FALLBACK_STUCK_SESSION": {
        "ENGLISH": "I'm not sure how to handle that. Let's start over. What do you need?",
        "HINGLISH": "Mujhe samajh nahi aaya. Chaliye shuru se shuru karte hain. Aapko kya chahiye?",
        "GUJLISH": "Mne samajh na avyu. Chalo fari shuru kariye. Aapne su joiye che?"
    },
    "ESTIMATE_QUESTION_SUFFIX": {
        "ENGLISH": "\n\nWhen you're ready, please list the specific clothes you have for pickup!",
        "HINGLISH": "\n\nJab aap taiyar hon, kripya pickup ke liye apne kapde list karein!",
        "GUJLISH": "\n\nJyare tame taiyar ho, kripa kari pickup mate aapna kapda ni list janavo!"
    },
    "PRICING_TITLE_dry_clean": {
        "ENGLISH": "Dry Clean Prices",
        "HINGLISH": "Dry Clean Ke Rate",
        "GUJLISH": "Dry Clean no Bhav"
    },
    "PRICING_DESC_dry_clean": {
        "ENGLISH": "Premium dry cleaning including automated steam pressing",
        "HINGLISH": "Premium dry cleaning aur automated steam pressing ke saath",
        "GUJLISH": "Premium dry cleaning ane automated steam pressing sathe"
    },
    "PRICING_TITLE_washing": {
        "ENGLISH": "Washing Prices",
        "HINGLISH": "Dhona (Washing) Ke Rate",
        "GUJLISH": "Dhova (Washing) no Bhav"
    },
    "PRICING_DESC_washing": {
        "ENGLISH": "Standard machine wash, tumble dry, and finish press",
        "HINGLISH": "Standard machine wash, tumble dry, aur finish press",
        "GUJLISH": "Standard machine wash, tumble dry, ane finish press"
    },
    "PRICING_TITLE_steam_press": {
        "ENGLISH": "Steam Press Prices",
        "HINGLISH": "Steam Press / Istree Ke Rate",
        "GUJLISH": "Steam Press / Istree no Bhav"
    },
    "PRICING_DESC_steam_press": {
...
def t(key: str, lang: str = "ENGLISH", **kwargs) -> str:
    lang = (lang or "ENGLISH").upper()
    if lang not in ["ENGLISH", "HINGLISH", "GUJLISH"]:
        lang = "ENGLISH"
        
    translations_for_key = TRANSLATIONS.get(key)
    if not translations_for_key:
        return f"[{key}]"
        
    template = translations_for_key.get(lang, translations_for_key.get("ENGLISH", f"[{key}]"))
    try:
        return template.format(**kwargs)
    except KeyError as e:
        print(f"Translation KeyError for key '{key}', lang '{lang}': {e}")
        return template
